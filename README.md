...
| <br/>- 빌드, 배포<br/>- 서버, 데이터베이스<br/>- DevOps | -Member & Spring Security<br/>- Playlist, Chatroom | -Like, Follow | - Board<br/>- Comment<br/>- Global | -Player<br/>- Create romm<br/>- Redux<br/>- Figma | 123 | 123 | 123 |
